...
public class RegisterFormPage extends MethodHandles {
    ...
    private final By signUpBtn = By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/form[1]/div[1]/div[11]/button[1]");
    private final By getErrorText = By.cssSelector("#reg_error_inner");
   ...
   public void chooseGender(){
    ...
    public MoreInfoPage clickOnSignUpBtn() throws InterruptedException {
        click(signUpBtn , 40);
        Thread.sleep(10000);
    ...
    public String getErrorRegisterMessage(){
     return getText( getErrorText,4);
    }

    public void registerFormActions(String firstName,String Surname,String day, String month,String year,String email,String password) throws InterruptedException {
